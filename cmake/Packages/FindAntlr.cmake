...
if (ANTLR_INCLUDE_DIR AND ANTLR_LIBRARIES)
	...
	if(NOT ANTLR_LIBRARIES)
		set(ANTLR_LIBRARIES ${IOC_DEP_DIRS}/javalib/antlr3-antlr-3.5/runtime/C)
		if(_carch_x64)
			set(ANTLR_LIBRARIES ${ANTLR_LIBRARIES}/x64/Release)
		else(_carch_x64)
			set(ANTLR_LIBRARIES ${ANTLR_LIBRARIES}/Release)
		endif(_carch_x64)
